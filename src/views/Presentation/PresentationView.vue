...
//images
import vueMkHeader from "@/assets/img/Barcelona-img.jpg";
...
<template>
  ...
  <Header>
    <div
      ...
      loading="lazy"
    >
      <span class="mask" style="background-color: hsla(0, 0%, 0%, 0.55)"></span>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-7 text-center mx-auto position-relative">
            ...
            >Rapid Transfers</h1>
            <p class="lead text-white px-5 mt-3" :style="{ fontWeight: '800' }">
